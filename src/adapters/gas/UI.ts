...
function buildMainCard(e: GoogleAppsScriptEvent, initialData: ParsedData | null = null, isTagChange = false, flashMessage: any = null): GoogleAppsScript.Card_Service.Card {
  ...
  const state = {
    ...
    section: formInput.section || (initialData && (initialData.section || initialData.specSection)) || "",
    number: formInput.number || (initialData && (initialData.number || initialData.submittalNum)) || "",
    revision: formInput.revision || (initialData && (initialData.revision || initialData.revNum)) || CONFIG.DEFAULT_REVISION,
