...
Use the `invoke_subagent` tool to spawn both sub-agents in a single tool call. Set the `Model` argument to `pro` for both to ensure they use the **Pro 3.1 High** model.
